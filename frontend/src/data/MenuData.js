...
const menuItems = [
  ...
  { icon: SearchIcon, label: 'Buscar', id: 'search' },
  { icon: EmployeesIcon, label: 'Empleados', id: 'employees' },
  { icon: CustomersIcon, label: 'Clientes', id: 'customers' },
  { icon: ProductsIcon, label: 'Productos', id: 'products' },
  { icon: RawMaterialsIcon, label: 'Materias Primas', id: 'rawmaterials' },
  { icon: CollectionsIcon, label: 'Colleciones', id: 'collections' },
  { icon: CategoriesIcon, label: 'Categorías', id: 'categories' },
