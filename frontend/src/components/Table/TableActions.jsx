        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 flex-1">
          ...
          {onSearch && (
            <div className="relative flex-1 max-w-md">
              ...
              <input type="text" placeholder="Buscar..." value={searchValue} onChange={handleSearchChange} className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg bg-[#EBFEF5] text-[#3D1609] placeholder-[#39312F] focus:outline-none focus:ring-2 focus:ring-[#A73249] focus:border-transparent transition-colors"/>
            </div>
          )}
        </div>
